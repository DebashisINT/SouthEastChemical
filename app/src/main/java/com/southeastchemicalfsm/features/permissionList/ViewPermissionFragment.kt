package com.southeastchemicalfsm.features.permissionList
...
import com.southeastchemicalfsm.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.southeastchemicalfsm.permission.C2D",""), list.get(i))
