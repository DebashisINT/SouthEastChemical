package com.southeastchemicalfsm.features.logoutsync.presentation
...
import com.southeastchemicalfsm.CustomConstants
...
import com.southeastchemicalfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.southeastchemicalfsm.features.billing.api.AddBillingRepoProvider
import com.southeastchemicalfsm.features.billing.model.AddBillingInputParamsModel
...
import com.southeastchemicalfsm.features.dashboard.presentation.ReasonDialog
...
import com.southeastchemicalfsm.features.document.model.AddEditDocumentInputParams
import com.southeastchemicalfsm.features.document.model.DocumentAttachmentModel
...
import com.southeastchemicalfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.southeastchemicalfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.southeastchemicalfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.southeastchemicalfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.southeastchemicalfsm.features.orderhistory.model.*
...
import com.southeastchemicalfsm.features.quotation.model.AddQuotInputModel
import com.southeastchemicalfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.southeastchemicalfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.southeastchemicalfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.southeastchemicalfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.southeastchemicalfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.southeastchemicalfsm.features.timesheet.model.AddTimeSheetInputModel
import com.southeastchemicalfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.southeastchemicalfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.southeastchemicalfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.southeastchemicalfsm.mappackage.SendBrod
import com.southeastchemicalfsm.widgets.AppCustomTextView
import com.southeastchemicalfsm.MonitorService
...
import com.southeastchemicalfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.southeastchemicalfsm.features.login.model.GetConcurrentUserResponse
import com.southeastchemicalfsm.features.performance.model.Gps_status_list
import com.southeastchemicalfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.southeastchemicalfsm.features.returnsOrder.ReturnProductList
import com.southeastchemicalfsm.features.returnsOrder.ReturnRequest
import com.southeastchemicalfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xsoutheastchemicalfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xsoutheastchemicalfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xsoutheastchemicalfsmlogsample/log.zip").path);
